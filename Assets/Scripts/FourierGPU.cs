...
namespace OceanWhiteCaps
{
	...
	/// <summary>
	/// Class to perform fourier tranform 
	/// on the GPU.
	/// </summary>
	public class FourierGPU
	{
		...
		public FourierGPU(int size)
		{
			...
			Shader shader = Shader.Find("Ocean/Fourier");
			
			if (shader == null)
				throw new InvalidOperationException("Could not find shader Ocean/Fourier shader.");
		...
		/// <summary>
		/// Perform fourier tranform on two textures.
		/// </summary>
